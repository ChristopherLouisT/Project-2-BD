...
public class KelasSuatuTahunController{
    ...
    public void handleAddKelasTahunbutton() {
        ...
        try {
            Integer.parseInt(addIdKelasField.getText());
            Integer.parseInt(addIdTahunAjaranField.getText());
        } catch (Exception e) {
            showAlert(Alert.AlertType.ERROR, "Input Error!", "Please incorrect value");
            return;
        }
        ...
        try {
            ...
            showAlert(Alert.AlertType.ERROR, "Input Error!", "There is an ID relation with other things but");
            return;
        }
    }
    ...
    public void handleDeleteKelasTahunButton(){
        ...
        try {
            ...
            showAlert(Alert.AlertType.ERROR, "No Data", "Please select a data");
            return;
        }
    }
    public void handleReadKelasTahunButton(){
        ...
        String query = "SELECT * FROM kelas_suatu_tahun WHERE " + columnName + " = " + search;

        if(columnName.equals("kelas_suatu_tahun")){
            query = "SELECT * FROM kelas_suatu_tahun WHERE " + columnName + " like " + "'%" + search + "%'";
        }
